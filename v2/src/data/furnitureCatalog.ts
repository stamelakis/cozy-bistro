...
export const furnitureCatalog: readonly FurnitureDef[] = [
  ...
  { id: "toilet",         name: "Toilet",          category: "bathroom",
    modelPath: "assets/kenney/toilet.glb", scale: 0.85, size: { width: 1, depth: 1 }, cost: 100, style: 2,
    tier: 1 },
  { id: "toilet-square",  name: "Square Toilet",   category: "bathroom",
    modelPath: "assets/kenney/toiletSquare.glb", scale: 0.85, size: { width: 1, depth: 1 }, cost: 280, style: 3,
    tier: 2 },
  ...
  { id: "bathroom-sink-sq", name: "Square Bath Sink", category: "bathroom",
    modelPath: "assets/kenney/bathroomSinkSquare.glb", scale: 0.85, size: { width: 1, depth: 1 }, cost: 220, style: 3,
    tier: 2 },
  ...
  { id: "bathroom-cabinet", name: "Bath Cabinet",  category: "bathroom",
    modelPath: "assets/kenney/bathroomCabinet.glb", scale: 0.85, size: { width: 1, depth: 1 }, cost: 140, style: 2,
    tier: 2 },
  { id: "bathroom-cabinet-d", name: "Bath Cabinet (Drawer)", category: "bathroom",
    modelPath: "assets/kenney/bathroomCabinetDrawer.glb", scale: 0.85, size: { width: 1, depth: 1 }, cost: 250, style: 3,
    tier: 2 },
