...
export const furnitureCatalog: readonly FurnitureDef[] = [
  ...
  { id: "fridge",         name: "Fridge",          category: "storage",
    ...
    tier: 2, stockCapacity: 2, surfaceSlots: [{ dx: 0, dz: 0 }] },
  ...
  { id: "fridge-large",   name: "Walk-in Fridge",  category: "storage",
    ...
    tier: 4, targetHeight: 2.2, stockCapacity: 6,
  ...
  { id: "bar-end",        name: "Bar End",         category: "counter",
    modelPath: "assets/kenney/kitchenBarEnd.glb", scale: S_KITCHEN, size: { width: 1, depth: 1 }, cost: 150, ratingBonus: 0.01,
    tier: 2 },
