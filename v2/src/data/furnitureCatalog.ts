...
export const furnitureCatalog: readonly FurnitureDef[] = [
  ...
  { id: "kitchen-hood",   name: "Range Hood",      category: "decoration",
    modelPath: "assets/kenney/hoodModern.glb", scale: S_KITCHEN, size: { width: 1, depth: 1 }, cost: 150, ratingBonus: 0.03,
    tier: 3 },
  { id: "kitchen-hood-l", name: "Large Range Hood", category: "decoration",
    modelPath: "assets/kenney/hoodLarge.glb", scale: S_KITCHEN, size: { width: 1, depth: 1 }, cost: 240, ratingBonus: 0.04,
    tier: 3 },
  ...
  { id: "wine-wall",       name: "Wine Wall",         category: "decoration",
    modelPath: "proc:wine-wall", scale: S_PROC, size: { width: 1, depth: 1 }, cost: 750, style: 6, ratingBonus: 0.07, attractionBonus: 3,
    tier: 5 },
