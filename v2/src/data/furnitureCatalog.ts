...
export const furnitureCatalog: readonly FurnitureDef[] = [
  ...
  { id: "stove",          name: "Gas Stove",       category: "stove",
    modelPath: "assets/kenney/kitchenStove.glb", scale: S_KITCHEN, size: { width: 1, depth: 1 }, cost: 240, ratingBonus: 0.01,
    tier: 2, provides: "stove" },
  { id: "stove-electric", name: "Electric Stove",  category: "stove",
    modelPath: "assets/kenney/kitchenStoveElectric.glb", scale: S_KITCHEN, size: { width: 1, depth: 1 }, cost: 480, ratingBonus: 0.04,
  ...
  { id: "sink",           name: "Sink",            category: "wash",
    modelPath: "assets/kenney/kitchenSink.glb", scale: S_KITCHEN, size: { width: 1, depth: 1 }, cost: 150, ratingBonus: 0.01,
    tier: 2 },
  { id: "dishwasher",     name: "Dishwasher",      category: "wash",
    modelPath: "proc:dishwasher", scale: S_PROC, size: { width: 1, depth: 1 }, cost: 450, ratingBonus: 0.04,
    tier: 3 },
  { id: "dishwasher-pro", name: "Pro Dishwasher Line", category: "wash",
    modelPath: "proc:dishwasher-pro", scale: S_PROC, size: { width: 1, depth: 1 }, cost: 1500, ratingBonus: 0.09,
    tier: 5 },
  { id: "microwave",      name: "Microwave",       category: "appliance",
    modelPath: "assets/kenney/kitchenMicrowave.glb", scale: S_KITCHEN, size: { width: 1, depth: 1 }, cost: 100, ratingBonus: 0.01,
  ...
  { id: "coffee-machine", name: "Coffee Machine",  category: "appliance",
    modelPath: "assets/kenney/kitchenCoffeeMachine.glb", scale: S_KITCHEN, size: { width: 1, depth: 1 }, cost: 250, ratingBonus: 0.04,
    tier: 3, placement: "surface", provides: "coffee" },
  { id: "blender",        name: "Blender",         category: "appliance",
    modelPath: "assets/kenney/kitchenBlender.glb", scale: S_KITCHEN, size: { width: 1, depth: 1 }, cost: 80, ratingBonus: 0.01,
    tier: 2, placement: "surface", provides: "blender" },
