...
export const furnitureCatalog: readonly FurnitureDef[] = [
  ...
  { id: "cloth-table",   name: "Tablecloth Top", category: "table",
    modelPath: "assets/kenney/tableCloth.glb", scale: 1, size: { width: 1, depth: 1 }, cost: 40 },
  { id: "glass-table",   name: "Glass Table",   category: "table",
    modelPath: "assets/kenney/tableGlass.glb", scale: 1, size: { width: 1, depth: 1 }, cost: 56 },
  ...
  { id: "coffee-glass",  name: "Glass Coffee Table", category: "table",
    modelPath: "assets/kenney/tableCoffeeGlass.glb", scale: 1, size: { width: 1, depth: 1 }, cost: 38 },
  ...
  { id: "bench-cushion-low", name: "Low Cushion Bench", category: "chair",
    modelPath: "assets/kenney/benchCushionLow.glb", scale: 1, size: { width: 2, depth: 1 }, cost: 48 },
  { id: "bench-plain",    name: "Wooden Bench",  category: "chair",
    modelPath: "assets/kenney/bench.glb", scale: 1, size: { width: 2, depth: 1 }, cost: 40 },
  { id: "bar-stool-sq",   name: "Square Bar Stool", category: "chair",
    modelPath: "assets/kenney/stoolBarSquare.glb", scale: 1, size: { width: 1, depth: 1 }, cost: 22 },
  { id: "lounge-relax",   name: "Relax Lounge",  category: "chair",
    modelPath: "assets/kenney/loungeChairRelax.glb", scale: 1, size: { width: 1, depth: 1 }, cost: 72 },
  { id: "lounge-design",  name: "Designer Lounge", category: "chair",
    modelPath: "assets/kenney/loungeDesignChair.glb", scale: 1, size: { width: 1, depth: 1 }, cost: 88 },
  { id: "sofa",           name: "Sofa",          category: "chair",
    modelPath: "assets/kenney/loungeSofa.glb", scale: 1, size: { width: 2, depth: 1 }, cost: 120 },
  { id: "sofa-long",      name: "Long Sofa",     category: "chair",
    modelPath: "assets/kenney/loungeSofaLong.glb", scale: 1, size: { width: 3, depth: 1 }, cost: 170 },
  { id: "sofa-corner",    name: "Corner Sofa",   category: "chair",
    modelPath: "assets/kenney/loungeSofaCorner.glb", scale: 1, size: { width: 2, depth: 2 }, cost: 200 },
  { id: "sofa-design",    name: "Designer Sofa", category: "chair",
    modelPath: "assets/kenney/loungeDesignSofa.glb", scale: 1, size: { width: 2, depth: 1 }, cost: 240 },
